"""
VAR(2) Analysis - 7 Variables with Rank Cohorts + 2 Exogenous Controls
...
print("=" * 100)
print("VAR(2) ANALYSIS - 7 ENDOGENOUS + 2 EXOGENOUS VARIABLES")
print("=" * 100)
...
# Save model summary
try:
    with open('data/analysis/var_cohorts_7var_summary.txt', 'w') as f:
...
granger_df.to_excel('data/analysis/var_cohorts_7var_granger.xlsx', index=False)
...
try:
    ...
    print("  This suggests numerical issues remain")
    irf_success = False
...
if irf_success:
    ...
    plt.tight_layout()
    plt.savefig('data/analysis/var_cohorts_7var_irf.png', dpi=300, bbox_inches='tight')
...
if irf_success:
    ...
    plt.tight_layout()
    plt.savefig('data/analysis/var_cohorts_7var_fevd.png', dpi=300, bbox_inches='tight')
...
print("=" * 100)
print("  1. var_cohorts_7var_summary.txt - Full model summary")
print("  2. var_cohorts_7var_granger.xlsx - Granger causality results")
print("  3. var_cohorts_7var_irf.png - Impulse response functions")
print("  4. var_cohorts_7var_fevd.png - Variance decomposition")
print("=" * 100)

print("\nKEY VARIABLES:")
print("  Bureaucratic bloat: Field_Grade_Officers_Z (O4-O6)")
print("  Regulatory burden: Policy_Count_Log")
print("  Political layer: Total_PAS_Z")
print("  Leadership: GOFOs_Z (O7-O10)")
print("  Responsiveness: FOIA_Simple_Days_Z")
print("=" * 100)
